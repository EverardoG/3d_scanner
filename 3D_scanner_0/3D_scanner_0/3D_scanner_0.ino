...
void loop() {
  ...
  for (pan_pos = 60; pan_pos <= 120; pan_pos += 5) {
    ...
    for (tilt_pos = 90; tilt_pos <= 120; tilt_pos += 5) {
      ...
      Serial.print(pan_pos); Serial.print(" : "); Serial.print(tilt_pos - tilt_offset); Serial.print(" : "); Serial.println(cm);
    }
